            ...
            <form action="" id="save-data" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for=""> Aspek Instrumen</label>
                        <select name="aspek" id="aspek" class="form-control">
                            <option value="" selected disabled>PILIH</option>
                            <?php
                            foreach ($aspek as $r) {
                                echo '<option value="' . $r->id . '">' . $r->aspek . '</option>';
                            }
                            ?>
                        </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="" id="edit-data" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">Aspek Instrumen</label>
                        <select name="aspek" id="e_aspek" class="form-control">
                            <option value="" selected disabled>PILIH</option>
                            <?php
                            foreach ($aspek as $r) {
                                echo '<option value="' . $r->id . '">' . $r->aspek . '</option>';
...
<script>
    ...
    function load_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/load_instrumen_katim') ?>',
            type: 'POST',
            dataType: "HTML",
    ...
    function save_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/save_instrumen_katim') ?>',
            type: 'POST',
    ...
    function edit_data(id, no, aspek, instrumen) {
        $('#e_id').val(id);
        $('#e_no').val(no);
        $('#e_aspek').val(aspek);
    ...
    function update_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/update_instrumen_katim') ?>',
            type: 'POST',
    ...
    function hapus_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/delete_instrumen_katim') ?>',
            type: 'POST',
