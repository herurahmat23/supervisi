...
<script>
    ...
    function load_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/load_instrumen_evaluasi') ?>',
            type: 'POST',
            dataType: "HTML",
    ...
    function save_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/save_instrumen_evaluasi') ?>',
            type: 'POST',
    ...
    function edit_data(id, no, instrumen) {
        $('#e_id').val(id);
        $('#e_no').val(no);
    ...
    function update_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/update_instrumen_evaluasi') ?>',
            type: 'POST',
    ...
    function hapus_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/delete_instrumen_evaluasi') ?>',
            type: 'POST',
