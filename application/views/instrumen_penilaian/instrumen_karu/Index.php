...
<script>
    ...
    function load_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/load_instrumen_karu') ?>',
            type: 'POST',
            dataType: "HTML",
    ...
    function save_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/save_instrumen_karu') ?>',
            type: 'POST',
    ...
    function update_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/update_instrumen_karu') ?>',
            type: 'POST',
    ...
    function hapus_data() {
        $.ajax({
            url: '<?= site_url('Instrumen_penilaian/delete_instrumen_karu') ?>',
            type: 'POST',
